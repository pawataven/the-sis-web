...
export const findBloomQuiz: QuizStep[] = [
...

  {
    ...
    content: [
      ...
      'คุณได้ยินถึงคำแนะนำที่เคยได้ยิน คุณจึงตระหนักถึงเสียงเมื่อสักครู่ว่านี่อาจจะเป็นเสียงของนักทวี "สุนทรภู่"',
      "คุณจึงได้ทำตามก่อนออกเดินทางคุณมีความสงสัยในใจ คุณจึงเลือกที่จะถามบุคคลข้างหน้าว่า...",
    ],
